...
import 'package:time_app_android/main.dart';
...
void main() {
  ...
  testWidgets('Counter resets to 0', (WidgetTester tester) async {
    ...
    // Tap the '+' icon multiple times and trigger a frame to increment the counter.
    await tester.tap(find.byIcon(Icons.add));
    await tester.tap(find.byIcon(Icons.add));
    await tester.tap(find.byIcon(Icons.add));
    await tester.pump();

    // Verify that our counter has incremented to 3.
    expect(find.text('3'), findsOneWidget);

    // Tap the 'reset' icon and trigger a frame to reset the counter.
